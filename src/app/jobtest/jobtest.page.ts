...
@Component({
  ...
  templateUrl: './jobtest.page.html',
  styleUrls: ['./jobtest.page.scss'],
  
})
export class JobtestPage implements OnInit {
  job: any = {};
  jobs: any[] = [];
